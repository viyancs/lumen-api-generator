...
class CommandApiGenerator extends Command
{
     ...
     * @var string
     */
    protected $name = 'viyancs:make:api';
     ...
     * @var string
     */
    protected $description = 'Create api controller and api routes (viyancs/lumen-api-generator)';
